...
<div class="main-content">
  <section class="section">
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <form class="card mb-4" method="POST" action="{{ route('admin.dosen.update', $dosen->id) }}"
            ...
            <div class="card-body">
              <x-text-input name="nama" label="Nama" placeholder="Masukan nama" :value="$dosen->nama" />

              <x-text-input name="nip" label="NIP" placeholder="Masukan NIP" :value="$dosen->nip" />
              ...
              <x-text-area name="alamat" label="Alamat" placeholder="Masukan alamat" :value="$dosen->alamat" />
              ...
              <x-select name="id_prodi" label="Program Studi" placeholder="Pilih program studi"
                :value="Request::get('prodi')" :data="$prodi" :value="$dosen->id_prodi" />
